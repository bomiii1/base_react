import { ChevronRight, FastForward, Heart, Pause, Repeat, Rewind, Share2, Shuffle, Star } from "lucide-react";
  ...
  return(
    <div className="h-screen flex flex-col justify-center items-center bg-gray-200">
      ...
      <div className="w-100 h-110 bg-black rounded-2xl shadow-2xl overflow-hidden">
        ...
        {/* ----------- album img ---------- */}
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuJd-453ktL6TuFS3s9Aonc0ubCaerM4VpGGnPPPxXwg&s=10" className="w-full h-1/3 object-cover opacity-70"></img>
        
        {/* ---------- player ---------- */}
        <div className="w-full h-2/3 flex flex-col py-10 px-10 bg-white">
        ...
        {/* artist */}
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <Heart className="text-transparent fill-orange-600 opacity-80 cursor-pointer hover:fill-gray-400"/>
            </div>
          </div>
          ...
          <div className="pt-[30px] flex justify-between">
            ...
            <div className="flex items-center gap-2">
              <Repeat className="text-gray-200 cursor-pointer hover:fill-gray-400"/>
              <Shuffle className="text-gray-200 cursor-pointer hover:fill-gray-400"/>
            </div>
