  ...
  return (
    <div className="space-y-10 p-10">
      ...
      <div>
        ...
        <div className="w-32 h-32 bg-green-300 rounded-lg hover:rotate-180 duration-500"></div>
      </div>

      {/* translate */}
      <div>
        <h2 className="text-xl font-bold mb-3">translate</h2>
        <div className="w-32 h-32 bg-green-300 rounded-lg hover:translate-y-10 duration-300"></div>
      </div>
    </div>
  );
}
